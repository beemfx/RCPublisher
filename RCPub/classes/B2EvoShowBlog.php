...
{
	global $GLOBAL_SETTINGS_B2HOST;
	global $GLOBAL_SETTINGS_B2PWD;
	global $GLOBAL_SETTINGS_B2USER;
	global $GLOBAL_SETTINGS_B2DB;
	
	@ $db = new mysqli($GLOBAL_SETTINGS_B2HOST, $GLOBAL_SETTINGS_B2USER, $GLOBAL_SETTINGS_B2PWD, $GLOBAL_SETTINGS_B2USER);
