...
$params = array_merge( array(
	 ...
	 'content_start_excerpt' => '<div class="rc_content_block">',
	 'content_end_excerpt' => '</div>',
	 'content_start_full'  => '<div class="rc_content_block">',
...
switch( $content_mode ) {
	...
	// Full dislpay:
		...
		if( !empty($params['limit_files']) ) {	// Display attachments/files that are linked to this post:
			$Item->files( array(
